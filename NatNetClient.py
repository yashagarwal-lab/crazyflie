...
class NatNetClient:
    def __init__( self ):
        ...
        # Set this to a callback to receive per-unlabeled-marker data at each frame.
    ...
    def __createCommandSocket(self):
        ...
        result.settimeout(0.5)  # Add this line
        return result
    ...
    def __unpackMocapData( self, data ):
        ...
        for i in range( 0, unlabeledMarkersCount ):
            ...
            if self.unlabeledMarkerListener is not None:
                self.unlabeledMarkerListener( i, pos )
    ...
    def stop( self ):
        ...
        # self.sendCommand( self.NAT_DISCONNECT, "", self.commandSocket, (self.serverIPAddress, self.commandPort) )
